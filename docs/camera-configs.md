...
## OF - East Lunch Area - 005 （deviceId:2563）
...
## Nyard - Forklift Mec / H2O Tower （deviceId:2575）
...
## BreakroomHall_Bay4 （deviceId:19555）
...
## Bay1 - Emp GDD Ent - 001 （deviceId:2583）
...
## Bay2 - Lunch Hallway-002 （deviceId:2568）
...
## Breakroom1_Bay4 （deviceId:19554）
...
## Bay4 - Bay4 to Bay5 Entry - 018 （deviceId:2386）
...
## Bay1 - Stairway WH 2nd （deviceId:8147）
...
## Bay4 - DK74 Bay Ent - 003 （deviceId:2370）
...
## Bay4 - DK74 Ramp - 001 （deviceId:2371）
...
## Bay2 - A237 FR - 017 （deviceId:2431）
...
## C85-Exterior Exit Off （deviceId:2614）
...
## C081-Parking Valley （deviceId:8128）
...
## 160.118-Exterior （deviceId:2573）
...
## C86-Exterior (入口平台) （deviceId:2625）
